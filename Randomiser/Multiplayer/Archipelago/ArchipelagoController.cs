...
public class ArchipelagoController : MonoBehaviour
{
    ...
    private ArchipelagoItem[] items;
    private string[] loginErrors = new string[0];
...
internal static class WhenInputUnlocked
{
    private static void Postfix(bool ___ShouldLock)
    {
